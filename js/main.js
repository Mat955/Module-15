...
Phone.prototype.printInfo = function () {
    console.log('The phone brand is ' + this.brand + ' with system ' + this.system + ', color is ' + this.color + ' and the price is ' + this.price + '.' + ' We offer you 5 years warranty for only: ' + this.getWarrantyCost + '.');
};
